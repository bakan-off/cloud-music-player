...
![Release](https://img.shields.io/badge/Release-v1.0.8-success?logo=github)
![License](https://img.shields.io/badge/License-MIT-blue.svg)

## 📥 Скачать приложение

👉 **[Скачать cloud-music-player-v1.0.8.apk](https://github.com/bakan-off/cloud-music-player/releases/download/v1.0.8/cloud-music-player-v1.0.8.apk)**
...
- 🔤 **Выбор шрифта текста песен:** 4 стиля типографики (Современный, Компактный/Condensed в стиле Spotify, Классический с засечками, Винтажный моноширинный) с предпросмотром в Настройках и мгновенным применением.
- 📡 **Голосовые уведомления о сети и умное автовозобновление:** единый аудиотракт, при выходе из зоны Wi-Fi во время стриминга плеер встает на паузу и произносит **«Нет сигнала»**. При возвращении звучит **«Есть сигнал»**, и стрим продолжается с сохраненной секунды.
